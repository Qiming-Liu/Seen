...
/**
 * Servlet implementation class GetHeadImageServlet
 */
@WebServlet("/GetHeadImageServlet")
public class GetHeadImageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetHeadImageServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//读取json数据
         ...
         System.out.println("=======json is========获取头像!!!!"+acceptjson);
         if(acceptjson != ""){
